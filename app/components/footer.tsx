...
export default function Footer() {
  ...
  return (
    <>
      <footer className="flex justify-between absolute inset-x-0 bottom-0 footer items-center p-2 bg-neutral text-neutral- rounded-3xl">
        <aside className="items-center grid-flow-col">
          <Image src={"/alice.png"} width={40} height={40} alt="alice" />
          <p>Copyright © {getYear.getFullYear()} - All right reserved</p>
        </aside>
        <nav className="grid-flow-col gap-12 place-self-center justify-self-end">
          <Link href={"https://instagr.am/britoniers"} className="">
